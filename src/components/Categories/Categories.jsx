              ...
              {Categorie.map((image, idx) => (
                ...
                >
                  <div className="flex flex-col items-center group cursor-pointer">
                    {/* Circle Box */}
                    <div className="w-24 mt-3 shadow-lg h-24 sm:w-28 sm:h-28 flex items-center justify-center rounded-full border border-gray-300 dark:border-gray-600 bg-pink-50 dark:bg-gray-800 transition-transform duration-300 group-hover:scale-110 group-hover:border-[#08536e]">
                      <img
                        src={image.src}
                        alt={image.title}
                    ...
                    {/* Title */}
                    <p className="mt-2 text-center lg:text-[16px] w-full text-[14px]  font-[600] text-gray-800 dark:text-gray-100">
                      {image.title}
                    </p>
                  </div>
                </CarouselItem>
